    ...
    <div class="tableStyle">
      ...
      <el-table v-loading="loading" :data="tableData" stripe border :max-height="650">
        ...
        <el-table-column fixed="right" label="操作" width="220" align="center">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="handleCheck(scope.row)">审核</el-button>
            <el-button type="text" size="small" @click="handleEdit(scope.row)">操作</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
import { orderCheckStatus, orderEditStatus, orderList } from '@/api/theme/order/rate'
  ...
  methods: {
    ...
    createConnection() {
      ...
      this.client.on('connect', () => {
        ...
        this.client.subscribe(`platform=${getSiteData()}merchantOrderList`, (error) => {
          if (error) {
